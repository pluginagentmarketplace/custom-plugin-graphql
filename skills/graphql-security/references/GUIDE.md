...
This guide provides comprehensive documentation for the **graphql-security** skill in the custom-plugin-graphql plugin.
...
```bash
# Invoke the skill
claude "graphql-security - [your task description]"

# Example
claude "graphql-security - analyze the current implementation"
```
...
def implement_graphql_security(input_data):
    """
    Implement graphql-security functionality.
