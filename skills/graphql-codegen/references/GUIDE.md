...
This guide provides comprehensive documentation for the **graphql-codegen** skill in the custom-plugin-graphql plugin.
...
```bash
# Invoke the skill
claude "graphql-codegen - [your task description]"

# Example
claude "graphql-codegen - analyze the current implementation"
```
...
def implement_graphql_codegen(input_data):
    """
    Implement graphql-codegen functionality.
