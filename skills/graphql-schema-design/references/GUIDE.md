...
This guide provides comprehensive documentation for the **graphql-schema-design** skill in the custom-plugin-graphql plugin.
...
```bash
# Invoke the skill
claude "graphql-schema-design - [your task description]"

# Example
claude "graphql-schema-design - analyze the current implementation"
```
...
def implement_graphql_schema_design(input_data):
    """
    Implement graphql-schema-design functionality.
